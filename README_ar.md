...
- **أحجام خطوط العناصر** — تخصيص حجم خط عناصر النص الرئيسية في الشهادة لكل قالب، مع ترك الحقل فارغًا للاحتفاظ بالحجم الافتراضي.
...
- **إصلاح:** أُعيد تحزيم الإصدار بحيث صارت الترقيات عبر الإنترنت تتضمن قسم **أحجام خطوط العناصر** الموجود أصلًا في الشيفرة المصدرية
- **توثيق:** جرت مزامنة أمثلة وسم/أرشيف الإصدار الموثقة إلى `1.5.0.1`
...
**دون أي ضمان**. يتضمّن الملف الجذري [`LICENSE`](LICENSE) النص الكامل
للترخيص.
...
تستخدم هذه الإضافة عددًا صغيرًا من مكتبات الواجهة الأمامية والخطوط
الخارجية. تراخيصها متوافقة مع التوزيع تحت GPLv3، لكنها تبقى خاضعة
لشروطها الأصلية:

- **html2canvas** — ترخيص MIT
- **QRCode.js** — ترخيص MIT
- **Amiri** — ترخيص SIL Open Font License 1.1
- **Cairo** — ترخيص SIL Open Font License 1.1

تُحمَّل هذه الأصول وقت التشغيل من شبكات CDN عامة / Google Fonts، وهي غير
مضمَّنة داخل هذا المستودع.
